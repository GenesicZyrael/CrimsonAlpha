...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)	
	local e2=Ritual.CreateProc({handler=c,desc=aux.Stringid(id,1),lvtype=RITPROC_GREATER,filter=aux.FilterBoolFunction(Card.IsCode,27200600),location=LOCATION_DECK})
	c:RegisterEffect(e2)		
