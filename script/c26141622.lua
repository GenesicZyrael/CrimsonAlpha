...
function s.initial_effect(c)
	...
	e2:SetCost(s.cost)
	c:RegisterEffect(e2)
	local e3=Ritual.CreateProc({handler=c,desc=aux.Stringid(id,1),lvtype=RITPROC_GREATER,filter=aux.FilterBoolFunction(Card.IsCode,44536226),extrafil=s.extragroup,
